...
- Fix flaky `fs_watcher_dedup` test on Linux: assert on `ObjectAdded` count instead of total event count, since inotify may generate additional filesystem events
