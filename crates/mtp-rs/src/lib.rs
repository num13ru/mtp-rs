...
pub use transport::virtual_device::registry::{
    clear_dropped_paths, dropped_paths_since_pause, force_cancel_wedge, force_partial_read_caps,
    pause_watcher, register_virtual_device, rekey_virtual_object, rescan_virtual_device,
